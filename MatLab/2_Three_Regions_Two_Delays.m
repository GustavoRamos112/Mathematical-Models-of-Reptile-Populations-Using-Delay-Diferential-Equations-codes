...
global  b2  %declare variables as global to allow the dde23 solver to access
...
tau_3 = 11*b2;  %set our delay value tau_3
lags = [tau_2 tau_3];	% "lags" is the array that holds the time delay values
...
Af1 = AlliBirthDivsol.y(1,:);	%assigns female juveniles in R1 outputs
%array to a vector named after the variable
%it represents, "Af1".
Af2 = AlliBirthDivsol.y(2,:);	%assigns female juveniles in R2 outputs
%array to a vector named after the variable
%it represents, "Af2".
Am2 = AlliBirthDivsol.y(3,:);	%assigns male juveniles in R2 outputs array
%to a vector named after the variable it
 
%represents, "Am2".
Am3 = AlliBirthDivsol.y(4,:);	%assigns male juveniles in R3 outputs array
%to a vector named after the variable it
%represents, "Am3".
Bf1 = AlliBirthDivsol.y(5,:);	%assigns female teens in R1 outputs array to
%a vector named after the variable it
%represents, "Bf1".
Bf2 = AlliBirthDivsol.y(6,:);	%assigns female teens in R2 outputs array to
%a vector named after the variable it
%represents, "Bf2".
Bm2 = AlliBirthDivsol.y(7,:);	%assigns male teens in R2 outputs array to
%a vector named after the variable it
%represents, "Bm2".
Bm3 = AlliBirthDivsol.y(8,:);	%assigns male teens in R3 outputs array to
%a vector named after the variable it
%represents, "Bm3".
Cf1 = AlliBirthDivsol.y(9,:);	%assigns female adults in R1 outputs array
%to a vector named after the variable it
%represents, "Cf1".
Cf2 = AlliBirthDivsol.y(10,:); %assigns female adults in R2 outputs array
%to a vector named after the variable it
%represents, "Cf2".
Cm2 = AlliBirthDivsol.y(11,:);  %assigns male adults in R2 outputs array to
%a vector named after the variable it
%represents, "Cm2".
Cm3 = AlliBirthDivsol.y(12,:);  %assigns male adults in R3 outputs aray to
%a vector named after the variable it
%represents, "Cm3".


u=Af1+Bf1+Cf1;  %assigns the variable "u" to be equal to the total female
%population in R1
v=Af2+Bf2+Cf2;  %assigns the variable "v" to be equal to the total female
%population in R2
w=Am2+Bm2+Cm2;  %assigns the variable "w" to be equal to the total male
%population in R2
q=Am3+Bm3+Cm3; %assigns the variable "q" to be equal to the total male
%population in R3
...
d1=.14;	%d1 is the death rate of the juveniles and is set at a desired value 
d2=.11;	%d2 is the death rate of the teens and is set at a desired value 
d3=.0695;	%d3 is the death rate of the adults and is set at a desired value 
...
k1=.79;	%k1 is the carrying capacity of R1 and is set at a desired value 
k2=.15;	%k2 is the carrying capacity of R2 and is set at a desired value
k3=.06;	%k3 is the carrying capacity of R3 and is set at a desired value
...
a1=d1./b2;  %a1 is the death rate of the juveniles divided by the birth rate for the adults 
a2=d2./b2;  %a2 is the death rate of the teens divided by the birth rate for the adults 
a3=d3./b2;  %a3 is the death rate of the adults divided by the birth rate for the adults
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
dydt(1)=r1*(((y(5))*(1-Q1))-s8*r1*(Lag1(5))*(1-Q3))-a1*y(1)+(y(9))*(1-Q1)...
-s8*(Lag1(9))*(1-Q3);
...
hist_1 = 10;    %this is the history of the female juvenile population from R1 
hist_2 = 10;    %this is the history of the female juvenile population from R2 
hist_3 = 10;    %this is the history of the male juvenile population from R2
hist_4 = 10;	%this is the history of the male juvenile population from R3
hist_5 = 10;	%this is the history of the female teen population from R1 
hist_6 = 7;	    %this is the history of the female teen population from R2 
hist_7 = 4;	    %this is the history of the male teen population from R2 
hist_8 = 4;	    %this is the history of the male teen population from R3
hist_9 = 5;	    %this is the history of the female adult population from R1 
hist_10 = 3;	%this is the history of the female adult population from R2 
hist_11 = 1;	%this is the history of the male adult population from R2 
hist_12 = 1;	%this is the history of the male adult population from R3
